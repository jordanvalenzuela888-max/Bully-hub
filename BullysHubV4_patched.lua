...
do
    ...
    if ok0 and Sync then
        ...
        print("[BullysHub] Anti-cheat patched")
    end
end

-- ============================================================
-- BULLY'S HUB CODE BELOW
-- ============================================================
if not game:IsLoaded() then game.Loaded:Wait() end
